...
(function($) {
  ...
  $(window).load(function() { scaleContenuImages(); });
...
//**********************************************************************************************
  ...
  $('#about').click(function(){
    jQuery('html,body').queue([]).stop();
    $.scrollTo(($('#'+params.AscensorName+'3')),1000, {axis:params.NavigationDirection,onAfter:function(){
      if(params.ReturnURL==true){
				if(trueURL==PrevWindows){
					window.location.href='#/'+params.AscensorName+'0';
				}else{
					window.location.href='#'+params.AscensorName+'3';
				}
			}
		}});
		return false;
